...
mkdir -p $ANA_INSTALL_PATH/opt/OSET/LiveISO
mkdir -p $ANA_INSTALL_PATH/opt/OSET/bin
cp  /opt/OSET/bin/precinctBallotCounter.sh $ANA_INSTALL_PATH/opt/OSET/bin
cp  /opt/OSET/bin/recoverPiggyBackData.sh $ANA_INSTALL_PATH/opt/OSET/bin
cp  /opt/OSET/bin/getSHA512Hash.sh $ANA_INSTALL_PATH/opt/OSET/bin
cp  /opt/OSET/bin/NIST_V1_election_resultsV50.xsd $ANA_INSTALL_PATH/opt/OSET/bin
%end
...
/opt/OSET/bin/precinctBallotCounter.sh 
exit
EOF
